...
{
    [CustomPropertyDrawer(typeof(CharacterAnimatorStateAttribute))]
    public class CharacterAnimatorStateAttributeDrawer : PropertyDrawerBase
    {
        protected override void OnGUISafe(Rect position, SerializedProperty property, GUIContent label)
        {
            var attr = (CharacterAnimatorStateAttribute) attribute;
            ...
            var animator = animatorRef.objectReferenceValue as CharacterAnimator;
